...
#import "ufsm-thesis-template.typ": thesis-template, glossario, apendice, anexo, tabela-abnt
...
#figure(
  table(
    ...
    table.header(
      [*Modalidade*], [*Resolução*], [*Tempo*], [*Aplicação Principal*],
    ),
...
#figure(
  table(
    ...
    table.header(
      [*Estudo*], [*Arquitetura*], [*Dataset*], [*Acurácia*], [*Ano*],
    ),
...
#glossario((
  (termo: "Acurácia", definicao: "Métrica que mede a proporção de predições corretas em relação ao total de predições realizadas."),
  (termo: "Backpropagation", definicao: "Algoritmo para calcular o gradiente da função de perda em relação aos pesos da rede neural, usado no treinamento."),
  (termo: "Ensemble", definicao: "Técnica que combina múltiplos modelos de aprendizado de máquina para melhorar o desempenho e robustez das predições."),
  (termo: "Overfitting", definicao: "Fenômeno que ocorre quando um modelo aprende padrões específicos dos dados de treinamento que não generalizam para novos dados."),
  (termo: "Transfer Learning", definicao: "Técnica que utiliza conhecimento adquirido em uma tarefa para melhorar o aprendizado em outra tarefa relacionada."),
))
...
#figure(
  table(
    ...
    align: (left, center, center, center),
    table.header(
      [*Patologia*], [*Sensibilidade*], [*Especificidade*], [*F1-Score*],
    ),
